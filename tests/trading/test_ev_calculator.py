...
class TestScanBracket:
    ...
    def test_below_threshold_returns_none(self) -> None:
        ...
        signal = scan_bracket(
            ...
            market_price_cents=22,
            min_ev_threshold_yes=0.10,
            min_ev_threshold_no=0.10,  # high threshold
            city="NYC",
            prediction_date="2026-02-18",
            confidence="medium",
            market_ticker="KXHIGHNY-26FEB18-B3",
    ...
    def test_no_opportunity_returns_none(self) -> None:
        ...
        signal = scan_bracket(
            ...
            min_ev_threshold_yes=0.01,
            min_ev_threshold_no=0.01,
            city="NYC",
            prediction_date="2026-02-18",
            confidence="medium",
            market_ticker="KXHIGHNY-26FEB18-B3",
