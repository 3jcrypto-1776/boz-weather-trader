...
tests/                   → 1260 backend + 163 frontend = 1423 tests (all passing)
  ...
  ├── api/         → API endpoints: auth, dashboard, health, markets, queue, settings, trades, trades/sync, accuracy, optimization, calendar (112)
