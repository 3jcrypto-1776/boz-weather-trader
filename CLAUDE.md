...
tests/                   → 1421 backend + 209 frontend = 1630 tests (1 known failure)
  ...
  ├── trading/     → Trading engine: EV calc, Kelly sizing, risk, cooldowns, queue, executor, scheduler, safety, sync, retraining trigger, bracket cap (276)
